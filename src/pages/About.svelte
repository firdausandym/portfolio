      ...
      >
        ...
        >
          <p class="first-letter:text-4xl first-letter:font-bold">
            What's up? I’m Andy, a software developer with expertise in web
            development. I am a Computer Engineer at State Polytechnic of Jember.
          </p>
          <p class="indent-4">
          ...
          <p class="indent-4">
            My expertise include JavaScript, .Net, and MERN stack. Recently I
            have been intrigue with python and flutter. Aside from coding,
            I enjoy playing video games, touring and cosplay.
          </p>
        </div>
        <!-- <Link
				data-aos="fade-left"
